...
public class CircleTimerView extends View {
    ...
    private static final float DEFAULT_GAP_BETWEEN_NUMBER_AND_LINE = 3;
    ...
    // Default color
    private static final int DEFAULT_CIRCLE_COLOR = 0xFFCDDC39;
    private static final int DEFAULT_CIRCLE_BUTTON_COLOR = 0xFFCDDC39;
    private static final int DEFAULT_LINE_COLOR = 0xFFE9E2D9;
    private static final int DEFAULT_HIGHLIGHT_LINE_COLOR = 0xFF9C27B0;
    private static final int DEFAULT_NUMBER_COLOR = 0x99866A60;
    private static final int DEFAULT_TIMER_NUMBER_COLOR = 0xFFCDDC39;
    private static final int DEFAULT_TIMER_COLON_COLOR = 0x80FA7777;
    private static final int DEFAULT_TIMER_TEXT_COLOR = 0xFF000000;
    ...
    // Parameters
    private static float mCx;
    private static float mCy;
    private static float mRadius;
    private static float mCurrentRadian;
    private static float mPreRadian;
    private static boolean mInCircleButton;
...
//            invalidate();
    ...
    // Runt
    private static CircleTimerListener mCircleTimerListener;
    ...
    private void initialize(final Context context) {
        ...
        // Set default dimension or cards xml attributes
        ...
        // Set default color or cards xml attributes
        mCircleColor = DEFAULT_CIRCLE_COLOR;
        mCircleButtonColor = DEFAULT_CIRCLE_BUTTON_COLOR;
        mLineColor = context.getResources().getColor(android.R.color.black);// DEFAULT_LINE_COLOR;
        mHighlightLineColor = context.getResources().getColor(R.color.colorPrimaryDark);//DEFAULT_HIGHLIGHT_LINE_COLOR;
        mNumberColor = DEFAULT_NUMBER_COLOR;
        mTimerNumberColor = context.getResources().getColor(R.color.colorAccent);//DEFAULT_TIMER_NUMBER_COLOR;
        mTimerTextColor = context.getResources().getColor(R.color.colorAccent);//DEFAULT_TIMER_TEXT_COLOR;
...
//        canvas.drawColor(Color.RED);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mLineLength / 2 + mGapBetweenCircleAndLine + mCircleStrokeWidth >= mCircleButtonRadius) {
            ...
            mRadius = width / 2 - (mCircleButtonRadius - mGapBetweenCircleAndLine - mLineLength / 2 -
    ...
    public void startTimer() {
        if (mCurrentRadian > 0 && !mStarted) {
            ...
            mStarted = true;
            if (mCircleTimerListener != null) {
                mCircleTimerListener.onTimerStart(mCurrentTime);
            }
        }
    }
    ...
    public void pauseTimer() {
        if (mStarted) {
            ...
            mStarted = false;
            if (mCircleTimerListener != null) {
                mCircleTimerListener.onTimerPause(mCurrentTime);
            }
        }
    }
    ...
    public void setCurrentTime(int time) {
        if (time >= 0 && time <= 3600) {
            ...
            mCurrentRadian = (float) (time / 60.0f * 2 * Math.PI / 60);
            invalidate();
        }
    }
    ...
    public void setCircleTimerListener(CircleTimerListener mCircleTimerListener) {
        CircleTimerView.mCircleTimerListener = mCircleTimerListener;
    }
